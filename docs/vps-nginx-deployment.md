...
```powershell
scp apps/desktop/src-tauri/target/release/bundle/nsis/M-Verify_0.1.1_x64-setup.exe wilson@157.173.114.45:/var/www/m-verify/downloads/M-Verify-Setup.exe
```
